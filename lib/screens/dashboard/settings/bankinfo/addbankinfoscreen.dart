...
class AddBankInfoScreen extends StatefulWidget {
  @override
  _AddBankInfoScreenState createState() => _AddBankInfoScreenState();
}
...
class _AddBankInfoScreenState extends State<AddBankInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("Add Bank Info", style: TextStyle(fontSize: 14, fontFamily: 'KiwiMedium'),),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                  ...
                  Provider.of<DashBoardProvider>(context, listen: false).createBankInfo(
